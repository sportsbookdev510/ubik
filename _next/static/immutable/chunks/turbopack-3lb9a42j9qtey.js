(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  {
    otherChunks: [
      "static/immutable/chunks/1lu82lmj0y481.js",
      "static/immutable/chunks/3zgr_fhe6lo3s.js",
      "static/immutable/chunks/2gj6sdo-k9_t0.js",
      "static/immutable/chunks/2cy4qse0vg65b.js",
    ],
    runtimeModuleIds: [10552],
  },
]),
  (() => {
    let e;
        ...
        let l = (function (e, t) {
          ...
          if (!r) {
            ...
            e.exports = e.namespaceObject = new Proxy(t, {
              ...
              has: (e, t) =>
                !!Reflect.has(e, t) ||
                ("default" !== t && "__esModule" !== t && void 0 !== n(t)),
              ownKeys(e) {
    ...
    function y(e, t, r) {
      ...
      for (
        let t = e;
        ("object" == typeof t || "function" == typeof t) && !m.includes(t);
        t = d(t)
      )
    ...
    async function j(e, t, r) {
      ...
      let o = r.included || [],
        l = o.map((e) => !!U.has(e) || _.get(e));
      if (l.length > 0 && l.every((e) => e)) return void (await Promise.all(l));
      for (let l of ((n = A(e, t, E(r.path))), o)) _.has(l) || _.set(l, n);
      await n;
    }
    k.l = function (e) {
    ...
    function q(e, t, r, n, o) {
      !(
        null == n ||
        (n instanceof DOMException && "NetworkError" === n.name)
      ) ||
      r.retryAttempts >= 1 ||
      L.get(t) !== r
